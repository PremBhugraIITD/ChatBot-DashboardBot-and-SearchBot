...
server.tool("listKnowledgeBases", {}, // Empty object for no parameters
async () => {
    try {
...
server.tool("createKnowledgeBase", {
    name: z.string(),
...
server.resource("documentation", "docs://smallest.ai", async (uri) => ({
    contents: [{
            uri: uri.href,
...
server.prompt("createKnowledgeBasePrompt", {
    name: z.string(),
    description: z.string()
}, ({ name, description }) => ({
    messages: [{
