            ...
            try {
                ...
                switch (request.params.name) {
                    case 'hubspot_create_contact': {
                        const result = await this.hubspot.createContact(args.firstname, args.lastname, args.email, args.properties);
                        return {
                            content: [{
                                    type: 'text',
                    ...
                    case 'hubspot_create_company': {
                        const result = await this.hubspot.createCompany(args.name, args.properties);
                        return {
                            content: [{
                                    type: 'text',
                                    text: JSON.stringify(result, null, 2)
                    ...
                    case 'hubspot_get_company_activity': {
                        const result = await this.hubspot.getCompanyActivity(args.company_id);
                        return {
                            content: [{
                                    type: 'text',
                                    text: JSON.stringify(result, null, 2)
                    ...
                    case 'hubspot_get_recent_engagements': {
                        const result = await this.hubspot.getRecentEngagements(args.days, args.limit);
                        return {
                            content: [{
                                    type: 'text',
                                    text: JSON.stringify(result, null, 2)
                    ...
                    case 'hubspot_get_active_companies': {
                        const result = await this.hubspot.getRecentCompanies(args.limit);
                        return {
                            content: [{
                                    type: 'text',
                                    text: JSON.stringify(result, null, 2)
                    ...
                    case 'hubspot_get_active_contacts': {
                        const result = await this.hubspot.getRecentContacts(args.limit);
                        return {
                            content: [{
                                    type: 'text',
                                    text: JSON.stringify(result, null, 2)
                    ...
                    case 'hubspot_update_contact': {
                        const result = await this.hubspot.updateContact(args.contact_id, args.properties);
                        return {
                            content: [{
                                    type: 'text',
                                    text: JSON.stringify(result, null, 2)
                    ...
                    case 'hubspot_update_company': {
                        const result = await this.hubspot.updateCompany(args.company_id, args.properties);
                        return {
                            content: [{
                                    type: 'text',
                                    text: JSON.stringify(result, null, 2)
