...
import { fieldRequiresOptions, getDefaultOptions } from "./types.js";
// Environment variables are provided by MCP client configuration
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            try {
                switch (request.params.name) {
                    ...
                    case "list_tables": {
                        const { base_id } = request.params.arguments;
                    ...
                    case "create_table": {
                        const { base_id, table_name, description, fields } = request.params.arguments;
                    ...
                    case "update_table": {
                        const { base_id, table_id, name, description } = request.params.arguments;
                    ...
                    case "create_field": {
                        const { base_id, table_id, field } = request.params.arguments;
                        // Validate field before creation
                        const validatedField = this.validateField(field);
                        const response = await this.axiosInstance.post(`/meta/bases/${base_id}/tables/${table_id}/fields`, validatedField);
                        return {
                            content: [{
                                    type: "text",
                                    text: JSON.stringify(response.data, null, 2),
                    ...
                    case "update_field": {
                        const { base_id, table_id, field_id, updates } = request.params.arguments;
                        const response = await this.axiosInstance.patch(`/meta/bases/${base_id}/tables/${table_id}/fields/${field_id}`, updates);
                        return {
                            content: [{
                                    type: "text",
                                    text: JSON.stringify(response.data, null, 2),
                    ...
                    case "list_records": {
                        const { base_id, table_name, max_records } = request.params.arguments;
                    ...
                    case "create_record": {
                        const { base_id, table_name, fields } = request.params.arguments;
                    ...
                    case "update_record": {
                        const { base_id, table_name, record_id, fields } = request.params.arguments;
                        const response = await this.axiosInstance.patch(`/${base_id}/${table_name}/${record_id}`, { fields });
                        return {
                            content: [{
                                    type: "text",
                                    text: JSON.stringify(response.data, null, 2),
                    ...
                    case "delete_record": {
                        const { base_id, table_name, record_id } = request.params.arguments;
                        const response = await this.axiosInstance.delete(`/${base_id}/${table_name}/${record_id}`);
                        return {
                            content: [{
                                    type: "text",
                                    text: JSON.stringify(response.data, null, 2),
                    ...
                    case "search_records": {
                        const { base_id, table_name, field_name, value } = request.params.arguments;
                        const response = await this.axiosInstance.get(`/${base_id}/${table_name}`, {
                            params: {
                ...
                if (axios.isAxiosError(error)) {
                    throw new McpError(ErrorCode.InternalError, `Airtable API error: ${error.response?.data?.error?.message ?? error.message}`);
                }
                throw error;
            }
        });
