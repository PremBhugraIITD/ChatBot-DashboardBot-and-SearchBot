...
// === TOOLS ===
// Get all deals
server.tool("get-deals", "Get all deals from Pipedrive including custom fields", {}, async () => {
    try {
...
// Get deal by ID
server.tool("get-deal", "Get a specific deal by ID including custom fields", {
...
// Search deals
server.tool("search-deals", "Search deals by term", {
...
// Get all persons
server.tool("get-persons", "Get all persons from Pipedrive including custom fields", {}, async () => {
    try {
...
// Get person by ID
server.tool("get-person", "Get a specific person by ID including custom fields", {
...
// Search persons
server.tool("search-persons", "Search persons by term", {
...
server.tool("get-organizations", "Get all organizations from Pipedrive including custom fields", {}, async () => {
    try {
...
server.tool("get-organization", "Get a specific organization by ID including custom fields", {
...
server.tool("search-organizations", "Search organizations by term", {
...
// Get all pipelines
server.tool("get-pipelines", "Get all pipelines from Pipedrive", {}, async () => {
    try {
...
// Get pipeline by ID
server.tool("get-pipeline", "Get a specific pipeline by ID", {
        ...
        for (const pipeline of pipelines) {
            try {
                ...
                if (stagesData.success && stagesData.data) {
                    const pipelineStages = stagesData.data.map((stage) => ({
                        ...stage,
...
// Search leads
server.tool("search-leads", "Search leads by term", {
...
server.tool("search-all", "Search across all item types (deals, persons, organizations, etc.)", {
