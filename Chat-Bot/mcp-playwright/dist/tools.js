    ...
    return [
        {
            ...
            inputSchema: {
                ...
                properties: {
                    ...
                    browserType: { type: "string", description: "Browser type to use (chromium, firefox, webkit). Defaults to chrome", enum: ["chromium", "firefox", "webkit", "chrome"] },
        ...
        },
        {
            ...
            description: "Get the HTML content of the current page. By default, all <script> tags are removed from the output unless removeScripts is explicitly set to false. Use minimal=true to get only interactive elements and their selectors for element selection.",
            inputSchema: {
                type: "object",
                properties: {
                    ...
                    minimal: { type: "boolean", description: "Return only interactive elements and their selectors for element selection (default: false)" }
                },
                required: [],
            },
        },
...
// All available tools (codegen tools removed for browser automation bot)
export const tools = [
    ...BROWSER_TOOLS,
    ...API_TOOLS
];
