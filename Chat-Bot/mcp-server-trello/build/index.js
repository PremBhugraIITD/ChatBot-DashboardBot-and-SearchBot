...
import { validateGetCardsListRequest, validateGetRecentActivityRequest, validateAddCardRequest, validateUpdateCardRequest, validateArchiveCardRequest, validateAddListRequest, validateArchiveListRequest, validateMoveCardRequest, validateAttachImageRequest, validateSetActiveBoardRequest, validateSetActiveWorkspaceRequest, validateListBoardsInWorkspaceRequest, } from './validators.js';
class TrelloServer {
    constructor() {
            ...
            try {
                ...
                switch (request.params.name) {
                    ...
                    case 'attach_image_to_card': {
                        ...
                        try {
                            const attachment = await this.trelloClient.attachImageToCard(validArgs.cardId, validArgs.imageUrl, validArgs.name);
                            return {
